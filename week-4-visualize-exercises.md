...
![](week-4-visualize-exercises_files/figure-commonmark/create-mpg-boxplot-1.png)
...
![](week-4-visualize-exercises_files/figure-commonmark/hwy-histogram-1.png)
...
![](week-4-visualize-exercises_files/figure-commonmark/add-binwidth-1.png)
...
![](week-4-visualize-exercises_files/figure-commonmark/scatterplot-aesthetic-mappings-1.png)
...
![](week-4-visualize-exercises_files/figure-commonmark/faceting-by-mpg-variables-1.png)

``` r
q + facet_grid(drv ~ .)
```

![](week-4-visualize-exercises_files/figure-commonmark/faceting-by-mpg-variables-2.png)

``` r
q + facet_grid(drv ~ cyl)
```

![](week-4-visualize-exercises_files/figure-commonmark/faceting-by-mpg-variables-3.png)

``` r
q + facet_wrap(~ class)
```

![](week-4-visualize-exercises_files/figure-commonmark/faceting-by-mpg-variables-4.png)
...
![](week-4-visualize-exercises_files/figure-commonmark/bar-plot-for-class-1.png)
